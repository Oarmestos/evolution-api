...
export class ConfigService {
  ...
  private envProcess(): Env {
    return {
      SERVER: {
        NAME: process.env?.SERVER_NAME || 'avri',
      ...
      PROVIDER: {
        ...
        PREFIX: process.env?.PROVIDER_PREFIX || 'avri',
      },
      DATABASE: {
        CONNECTION: {
          URI: process.env.DATABASE_CONNECTION_URI || '',
          CLIENT_NAME: process.env.DATABASE_CONNECTION_CLIENT_NAME || 'avri',
        },
      ...
      RABBITMQ: {
        ...
        EXCHANGE_NAME: process.env?.RABBITMQ_EXCHANGE_NAME || 'avri_exchange',
      ...
      NATS: {
        ...
        EXCHANGE_NAME: process.env?.NATS_EXCHANGE_NAME || 'avri_exchange',
      ...
      KAFKA: {
        ...
        CLIENT_ID: process.env?.KAFKA_CLIENT_ID || 'avri-api',
        ...
        CONSUMER_GROUP_ID: process.env?.KAFKA_CONSUMER_GROUP_ID || 'avri-api-consumers',
        TOPIC_PREFIX: process.env?.KAFKA_TOPIC_PREFIX || 'avri',
      ...
      WA_BUSINESS: {
        TOKEN_WEBHOOK: process.env.WA_BUSINESS_TOKEN_WEBHOOK || 'avri',
      ...
      CONFIG_SESSION_PHONE: {
        CLIENT: process.env?.CONFIG_SESSION_PHONE_CLIENT || 'Avri API',
      ...
      CACHE: {
        REDIS: {
          ...
          PREFIX_KEY: process.env?.CACHE_REDIS_PREFIX_KEY || 'avri-cache',
      ...
      AUTHENTICATION: {
        API_KEY: {
          KEY: process.env.AUTHENTICATION_API_KEY || 'avri_secret_key',
        },
